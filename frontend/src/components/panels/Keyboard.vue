...
<template>
    <main class="z-10 grid grid-flow gap-1 text-center">
        ...
        <div class="z-10 grid grid-flow-col gap-1 mr-10">
            <button class="btn btn-outline btn-xs" :class="{'bg-white': keys.KeyQ}" @click="click('KeyQ')">Q
            ...
            <button class="btn btn-outline btn-xs" :class="{'bg-white': keys.KeyW}" @click="click('KeyW')">W ▲</button>
            <button class="btn btn-outline btn-xs" :class="{'bg-white': keys.KeyE}" @click="click('KeyE')">E
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="size-5">
        ...
        <div class="z-10 grid grid-flow-col gap-1 ml-10">
            <button class="btn btn-outline btn-xs" :class="{'bg-white': keys.KeyA}" @click="click('KeyA')">A ◀︎</button>
            <button class="btn btn-outline btn-xs" :class="{'bg-white': keys.KeyS}" @click="click('KeyS')">S ▼</button>
            <button class="btn btn-outline btn-xs" :class="{'bg-white': keys.KeyD}" @click="click('KeyD')">D ▶︎</button>
        </div>
        <div class="z-10 grid grid-flow-col gap-1">
            <button class="btn btn-outline btn-xs" :class="{'bg-white': keys.ShiftLeft}" @click="hold('ShiftLeft')">Shift</button>
            <button class="btn btn-outline btn-xs" :class="{'bg-white': keys.ControlLeft}" @click="hold('ControlLeft')">Ctrl</button>
            <button class="btn btn-outline btn-xs" :class="{'bg-white': keys.AltLeft}" @click="hold('AltLeft')">Alt</button>
            <button class="btn btn-outline btn-xs px-10" :class="{'bg-white': keys.Space}" @click="click('Space')">Space</button>
        </div>
