/**
 * @typedef {import("../web-socket/ioTypes.js").IOAgent} IOAgent
 * @typedef {import("../web-socket/ioTypes.js").IOParcel} IOParcel
 * @typedef {import("../web-socket/ioTypes.js").IOTile} IOTile
 * @typedef {import("../web-socket/ioTypes.js").IOInfo} IOInfo
 * @typedef {import("../web-socket/IOConfig.js").IOConfig} IOConfig
 */
...
/**
 * @class IODeliveroojsApi
 */
export class IODeliveroojsApi {
    ...
    async richiediToken(nome, team, password) {
...
// Tests
// 
// const api = new IODeliveroojsApi('http://localhost:8080');
