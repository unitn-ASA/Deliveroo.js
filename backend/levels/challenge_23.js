...
module.exports = {
    ...
    MAP_FILE: 'challenge_23',    // options are 'default_map' (DEFAULT), 'empty_map', 'map_20', ...files in levels/maps

    PARCELS_GENERATION_INTERVAL: '1s',  // options are '1s', '2s' (DEFAULT), '5s', '10s'
    PARCELS_MAX: '3',                  // 'infinite' (DEFAULT)
    ...
    RANDOMLY_MOVING_AGENTS: 4,  // default is 2
