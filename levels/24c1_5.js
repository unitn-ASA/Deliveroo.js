...
module.exports = {
    ...
    MAP_FILE: '24c1_5',    // options are 'default_map' (DEFAULT), 'empty_map', 'map_20', ...files in levels/maps
    ...
    AGENTS_OBSERVATION_DISTANCE: 30,     // default is 5
    PARCELS_OBSERVATION_DISTANCE: 30,    // default is 5

    PARCEL_REWARD_AVG: 50,             // default is 30
    PARCEL_REWARD_VARIANCE: 100,     // default is 10
