...
module.exports = {
    ...
    MAP_FILE: '24c1_6',    // options are 'default_map' (DEFAULT), 'empty_map', 'map_20', ...files in levels/maps

    PARCELS_GENERATION_INTERVAL: '5s',  // options are '1s', '2s' (DEFAULT), '5s', '10s'
    PARCELS_MAX: '24',                  // 'infinite' (DEFAULT)

    MOVEMENT_STEPS: 1,                  // default is 1
    MOVEMENT_DURATION: 100,              // default is 500
    AGENTS_OBSERVATION_DISTANCE: 20,     // default is 5
    PARCELS_OBSERVATION_DISTANCE: 20,    // default is 5

    PARCEL_REWARD_AVG: 20,             // default is 30
    PARCEL_REWARD_VARIANCE: 20,     // default is 10
